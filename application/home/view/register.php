        ...
        <div class="container">
            <div class="login-content">
                <div class="login-form">
                    <form action="?c=register&a=index" method="post">
...
<!--                        <div class="checkbox">-->
<!--                            <label>-->
<!--                                <input type="checkbox">同意条款和政策-->
<!--                            </label>-->
<!--                        </div>-->
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30">注册</button>
